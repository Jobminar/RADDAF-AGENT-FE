...
const Upload = () => {
    ...
    //   const handleSubmit = () => {
    //     // Perform any final submit actions, and log the uploaded file names
    //     console.log('Uploaded Files:', uploadedFiles);
    //   };

      const uploadFiles = async () => {
        try {
          // Simulate an asynchronous operation, replace this with your actual upload logic
  ...
  return (
    <div className='maincont'>
        ...
        <div className=''>
            list image and documents
            <div className='cont2'>
                <div className='upimg'>
                    <div className='upim'>
                        {/* <img src={upload} alt='upload property'/> */}
                    </div>
                    <div className='upig'>
                        <div className='upmg'>
                ...
                <div className='cont3'>
                    ...
                    <div className='cont4'>
                        ...
                        />
                        <div className='contche' onClick={triggerFileInput}>
                            <div>
            ...
            {/* <div style={{display:'flex'}}>
                ...
                <div className='contche' style={{paddingLeft:"30px"}}>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                        </svg>
        ...
        <button onClick={uploadFiles}>Final Submit</button>
    </div>
  )
}
